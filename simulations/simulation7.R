...
d1 <- rbinom(n = sims, size = sim.stor[, 1],
             prob = model7(sim.stor[, 5], sim.stor[, 6], param7$p0, param7$b3, param7$b4)) # dispersal patch1
d2 <- rbinom(n = sims, size = sim.stor[, 2],
             prob = model7(sim.stor[, 6], sim.stor[, 5], param7$p0, param7$b3, param7$b4)) # dispersal patch2
