...
d1 <- rbinom(n = sims, size = sim.stor[, 1],
             prob = model5(sim.stor[, 1], sim.stor[, 2], sim.stor[, 5], sim.stor[, 6], param5$p0, param5$b1, param5$b2, param5$b3, param5$b4)) # dispersal patch1
d2 <- rbinom(n = sims, size = sim.stor[, 2],
             prob = model5(sim.stor[, 2], sim.stor[, 1], sim.stor[, 6], sim.stor[, 5], param5$p0, param5$b1, param5$b2, param5$b3, param5$b4)) # dispersal patch2
...
# Save results
write.table(sim.stor, file = "../data/simulation5.csv", sep = ",", col.names = TRUE, row.names = FALSE)
